      ...
      <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-4xl sm:w-full">
        ...
        <div class="bg-gray-50 px-6 py-4 border-t border-gray-200 flex justify-end space-x-3">
          <button
            @click="closeModal"
            type="button"
            class="px-4 py-2 text-sm font-medium text-[#0ea5e9] bg-white border border-[#38bdf8] rounded-md hover:bg-[#e0f2fe] focus:outline-none focus:ring-2 focus:ring-[#38bdf8] transition-colors"
          >
            Cancelar
          </button>
          <button
            ...
            type="submit"
            :disabled="loading"
            class="px-4 py-2 text-sm font-medium text-white bg-[#38bdf8] border border-transparent rounded-md hover:bg-[#0ea5e9] focus:outline-none focus:ring-2 focus:ring-[#38bdf8] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
