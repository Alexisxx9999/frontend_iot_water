...
/* Aplica Roboto solo al nombre de usuario (igual que la fecha) */
.navbar-user p.text-sm.font-medium {
  font-family: 'Roboto', Arial, sans-serif !important;
  letter-spacing: 0.5px;
}
/* El rol y otros títulos siguen con Poppins */
.navbar-user p.text-xs {
...
header, .navbar-user, .navbar-user-container {
  font-family: 'Roboto', Arial, sans-serif;
}

/* Fira Mono para botones (si los hay) */
