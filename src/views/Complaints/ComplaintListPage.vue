<template>
  <div class="complaint-list-page">
    <!-- Header premium -->
    <div class="complaints-header-premium new-premium-header">
      <div class="new-header-content">
        <div class="new-header-left animate-fadein">
          <h1 class="new-header-title">Denuncias Ciudadanas</h1>
          <div class="new-header-desc">
            Denuncias Administrativas - Sistema de Agua e IoT<br>
            Gestión interna de incidencias relacionadas con el sistema de agua, dispositivos IoT o problemas de medición.
          </div>
        </div>
        <div class="new-header-right">
          <div class="new-header-kpis">
            <div
              v-for="kpi in kpis"
              :key="kpi.label"
              class="kpi-card kpi-animate-glow animate-up"
              :style="{ background: `linear-gradient(135deg, var(--tw-gradient-stops, #fff, #f3f4f6))`, borderColor: kpi.iconColor }"
            >
              <component :is="kpi.icon" class="kpi-heroicon" :style="{ color: kpi.iconColor }" />
              <span class="kpi-value">{{ kpi.value }}</span>
              <span class="kpi-label">{{ kpi.label }}</span>
            </div>
          </div>
          <div class="new-header-graphs animate-up">
...
import { ClipboardDocumentListIcon, CheckCircleIcon, LockClosedIcon, ClockIcon } from '@heroicons/vue/24/outline'
...
.complaints-header-premium {
  /* Usa los estilos de _complaints.scss */
}
.complaints-header-content {
  display: flex;
...
.complaints-header-titles {
  flex: 1;
}
.complaints-header-title {
  font-size: 2rem;
  font-weight: 700;
  color: #0f172a;
}
.complaints-header-subtitle {
  font-size: 1.2rem;
  font-weight: 600;
  color: #0f172a;
}
.complaints-header-desc {
  font-size: 1rem;
  color: #64748b;
}
.complaints-header-right {
  display: flex;
  gap: 2rem;
}
.kpis-graphs-stack {
