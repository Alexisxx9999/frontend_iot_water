  ...
  <div class="role-create">
    <div class="institutional-video-banner">
      ...
      <div class="banner-caption">
        ...
        <p>Define un nuevo perfil de usuario con permisos específicos.</p>
      </div>
    </div>
    <div class="header">
      <h1><font-awesome-icon :icon="['fas', 'user-plus']" /> Crear Nuevo Rol</h1>
...
export default {
  ...
  setup() {
    ...
    return { form, handleSubmit, goBack }
  }
}
</script>
