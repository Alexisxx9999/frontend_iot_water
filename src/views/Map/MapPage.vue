<template>
  <div class="map-page">
    <div class="map-header-container">
      <header class="map-header-premium animate-fade-up">
        <div class="map-header-premium-inner">
          <div class="header-premium-left">
            <h1 class="header-premium-title">Mapa de Dispositivos</h1>
            <div class="header-premium-subtitle">Visualización geográfica de dispositivos</div>
          </div>
          <div class="header-premium-metrics">
            <div class="metric-premium metric-blue animate-fade-up metric-delay-1">
              <span class="metric-premium-icon metric-animate-bounce">💧</span>
              <span class="metric-premium-number">1,248,450</span>
              <span class="metric-premium-label metric-premium-m3">m³</span>
              <span class="metric-premium-label">Consumidos</span>
            </div>
            <div class="metric-premium metric-yellow animate-fade-up metric-delay-2">
              <span class="metric-premium-icon metric-animate-bounce">⚠️</span>
              <span class="metric-premium-number">12</span>
              <span class="metric-premium-label">Alertas</span>
              <span class="metric-premium-label">Activas</span>
            </div>
            <div class="metric-premium metric-cyan animate-fade-up metric-delay-3">
              <span class="metric-premium-icon metric-animate-bounce">📡</span>
              <span class="metric-premium-number">32</span>
              <span class="metric-premium-label">Dispositivos</span>
              <span class="metric-premium-label">IoT</span>
            </div>
            <div class="metric-premium metric-purple animate-fade-up metric-delay-4">
              <span class="metric-premium-icon metric-animate-bounce">👥</span>
              <span class="metric-premium-number">5,200</span>
              <span class="metric-premium-label">Usuarios</span>
              <span class="metric-premium-label">Atendidos</span>
            </div>
          </div>
        </div>
      </header>
